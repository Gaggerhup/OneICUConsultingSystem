...
export const loadInitialProfile = (defaultProfile: UserProfile): UserProfile => {
  ...
  if (!saved) {
    if (typeof window !== 'undefined' && localStorage.getItem('provider_session')) {
      return {
        ...defaultProfile,
        id: defaultProfile.id || 'session-user',
        title: defaultProfile.title ?? 'Dr.',
        firstName: '',
        lastName: '',
        specialty: '',
        hospital: '',
        ...
        avatarUrl: null,
        phoneNumber: '',
        isAcceptingCases: defaultProfile.isAcceptingCases,
        isAcceptingNotifications: defaultProfile.isAcceptingNotifications,
        license: '',
        telegramChatId: defaultProfile.telegramChatId,
        summary: defaultProfile.summary ?? null,
        notifPrefs: defaultProfile.notifPrefs,
      };
    }
