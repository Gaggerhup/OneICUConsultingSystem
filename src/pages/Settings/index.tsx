...
function Settings() {
  ...
  const [form, setForm] = useState({
    ...
    summary: 'Board-certified Cardiologist with over 12 years of experience in interventional cardiology. Specialized in preventive heart care, complex coronary interventions, and patient-centered treatment plans at Phitsanulok Hospital.',
  });
          ...
          {activeTab === 'profile' && (
            <div className="settings-panel">
              ...
              <div className="settings-card">
                ...
                <div className="form-group">
                  <label>Email Address (Clinical)</label>
                  <input
                    type="email"
                    value={form.email}
          ...
          {activeTab === 'notifications' && (
            <div className="settings-panel">
              ...
              <div className="settings-card">
                ...
                {[
                  { key: 'newRequest', label: 'New consultation request received', hint: 'Instant alert when a new transfer request arrives' },
                ...
                <p className="notif-section-title" style={{ marginTop: '1.5rem' }}>System & Reports</p>
                {[
                  { key: 'weeklyReport', label: 'Weekly summary report', hint: 'Summary of your consultation activity every Monday' },
                  { key: 'systemAlert', label: 'System maintenance alerts', hint: 'Planned downtime and maintenance windows' },
                ].map(({ key, label, hint }) => (
                  <div key={key} className="toggle-row bordered">
                    <div>
                      <p className="toggle-label">{label}</p>
