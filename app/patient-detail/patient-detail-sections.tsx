            ...
            <div className={styles['pd-hero-body']}>
              <div className={styles['pd-hero-primary']}>
                <div className={styles['pd-hero-topline']}>
                  <div className={styles['pd-hero-eyebrow']}>Patient Command Center</div>
                  <button
                    type="button"
                    className={styles['pd-ai-summary-btn']}
                    onClick={onGenerateAiSummary}
                    disabled={isGeneratingAiSummary || !record}
                    title="Generate AI case summary"
                  >
                    <Sparkles size={14} />
                    {isGeneratingAiSummary ? 'Summarizing...' : 'AI Summary'}
                  </button>
                </div>
                  ...
                  <div className={styles['pd-hero-info']}>
                    ...
                    <div className={styles['pd-hero-actions-panel']}>
                      <div className={styles['pd-hero-actions-copy']}>
                        <span className={styles['pd-hero-actions-label']}>Patient Actions</span>
                        <small>{caseStatus === 'Pending' ? 'Review and decide on this request.' : 'Edit details or finish the case.'}</small>
                      </div>
                ...
                <div className={styles['pd-hero-brief']}>
                  <div className={styles['pd-hero-brief-card']}>
                    ...
                    <strong>{record?.currentSymptoms || 'No symptom summary yet'}</strong>
                  </div>
                  <div className={styles['pd-hero-brief-card']}>
                    <span>Initial Diagnosis</span>
                    <strong>{record?.initialDiagnosis || 'Pending assessment'}</strong>
                  </div>
                </div>
              </div>
                  ...
                  {allergySummary.hasRisk ? (
                    <>
                      ...
                      <div className={styles['pd-hero-allergy-detail']}>
                        {allergySummary.details.length > 0 ? allergySummary.details.join(' · ') : 'Allergy history on file'}
                      </div>
                    </>
                  ) : (
    ...
    <main className={styles['pd-col-c']}>
      ...
      >
        <div className={styles['pd-accordion-copy']}>
          ...
          <small>{activeTabMeta?.label || 'Overview'}</small>
        </div>
          ...
          <>
              ...
              <div className={cx(styles, 'pd-fade-in', 'pd-overview-pane')}>
                <div className={styles['pd-section-header']}>
                  ...
                  <div className={styles['pd-inline-actions']}>
                    <button className={styles['pd-mini-action']} onClick={() => openVitalEditor()}><Plus size={13} /> Add Vital</button>
                  </div>
                </div>
                ...
                {vitalRows.length > 0 && (
                  <>
                    <div className={cx(styles, 'pd-section-title', 'pd-summary-title-spaced')}>VITAL HISTORY</div>
            ...
            {activeTab === 'labs' && (
              <div className={styles['pd-fade-in']}>
                <div className={styles['pd-section-header']}>
                  <div className={styles['pd-section-title']}>LAB RESULTS</div>
                  <button className={styles['pd-mini-action']} onClick={() => openLabEditor()}><Plus size={13} /> Add Lab</button>
                </div>
                {record && record.labs.length === 0 ? (
            ...
            {activeTab === 'medications' && (
              <div className={styles['pd-fade-in']}>
                <div className={styles['pd-section-header']}>
                  <div className={styles['pd-section-title']}>MEDICATIONS</div>
                  <button className={styles['pd-mini-action']} onClick={() => openMedicationEditor()}><Plus size={13} /> Add Medication</button>
                </div>
