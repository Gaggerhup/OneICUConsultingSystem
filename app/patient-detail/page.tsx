...
function buildFallback(selectedCase: any, t: (key: string, vars?: Record<string, string>) => string): PatientRecord {
  return {
    ...
    currentSymptoms: selectedCase?.currentSymptoms || selectedCase?.reason || t('common.noData'),
      ...
      try {
        ...
        if (dbCase) {
          ...
          setRecord({
            ...
            currentSymptoms: dbCase.currentSymptoms || selectedCase?.currentSymptoms || selectedCase?.reason || '',
