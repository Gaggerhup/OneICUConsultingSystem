      ...
      <div className={styles['nr-form-sections']}>
        ...
        <section className={cx(styles, 'nr-card', 'nr-card-patient')}>
          ...
          <div className={styles['nr-row']}>
            <div className={styles['nr-group']}>
              ...
              <textarea rows={2} placeholder="Comma-separated conditions" value={formData.conditions} onChange={(event) => onInputChange('conditions', event.target.value)} />
            </div>
            <div className={styles['nr-group']}>
              <label>{t('newRequest.allergies')}</label>
              <textarea rows={2} placeholder="Comma-separated allergies" value={formData.allergies} onChange={(event) => onInputChange('allergies', event.target.value)} />
            </div>
          </div>
        </section>
        ...
        <section className={cx(styles, 'nr-card', 'nr-card-clinical')}>
          ...
          <div className={cx(styles, 'nr-group', 'spaced-group')}>
            <label>{t('newRequest.currentSymptomsLabel')}</label>
            <textarea rows={4} placeholder={t('newRequest.currentSymptomsPlaceholder')} value={formData.currentSymptoms} className={fieldClassName('currentSymptoms')} onChange={(event) => onInputChange('currentSymptoms', event.target.value)} />
            {renderError('currentSymptoms')}
          </div>
          <div className={styles['nr-row']}>
            <div className={styles['nr-group']}>
              <label>{t('newRequest.initialDiagnosis')}</label>
              <input type="text" placeholder="Initial diagnosis" value={formData.initialDiagnosis} className={fieldClassName('initialDiagnosis')} onChange={(event) => onInputChange('initialDiagnosis', event.target.value)} />
