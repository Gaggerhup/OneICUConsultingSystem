...
const notificationToggleKeys: Array<{
  ...
  { key: 'newRequest', labelKey: 'settings.notificationNewRequest', hintKey: 'settings.notificationNewRequestHint' },
  { key: 'requestApproved', labelKey: 'settings.notificationStatusChange', hintKey: 'settings.notificationStatusChangeHint' },
  { key: 'newMessage', labelKey: 'settings.notificationNewMessage', hintKey: 'settings.notificationNewMessageHint' },
  { key: 'caseUpdate', labelKey: 'settings.notificationCaseUpdate', hintKey: 'settings.notificationCaseUpdateHint' },
];
  ...
  return (
    <div className={styles['settings-panel']}>
      ...
      <div className={styles['settings-card']}>
        ...
        <p className={styles['notif-section-title']}>{t('settings.telegramPersonalChat')}</p>
        <div className={cx(styles, 'toggle-row', 'bordered')}>
          <div style={{ flex: 1, paddingRight: '1rem' }}>
            <p className={styles['toggle-label']}>{t('settings.telegramChatId')}</p>
        ...
        {notificationToggleKeys.map(({ key, labelKey, hintKey }) => (
