...
function Login() {
  ...
  const devAccessLabel = language === 'th' ? 'เข้าสู่ระบบสำหรับทดสอบ' : 'Sign in for testing';
        ...
        <div className={styles['login-card']}>
          ...
          <div className={styles['card-body']}>
            ...
            <div className={styles['login-options']}>
              ...
              <button className={styles['dev-access-btn']} type="button" onClick={authService.setupMockSession}>
                {devAccessLabel}
              </button>
            </div>
          </div>
